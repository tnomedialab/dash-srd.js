...
define('sequencing/slidingwindow',['util/eventutils', 'util/motionutils'], 
...
define('sequencing/main',['./sequencer', './windowsequencer', './timingcallbacks','./slidingwindow'], 
	function (seq, WindowSequencer, timingcallbacks, SlidingWindow) {		
		'use strict';
...
define ('timingsrc',['./timingobject/main', './sequencing/main', './mediasync/mediasync'], 
	...
	return {
		...
		SlidingWindow : sequencing.SlidingWindow,
